...
public class Structure {
    ...
    public void lightUp(Location core) {
        List<StructureBlock> structureBlocks = new ArrayList<>(blocks);
        structureBlocks.add(this.core);
        for (StructureBlock structureBlock : structureBlocks) {
            Block block = structureBlock.getVector().getLocation(core).getBlock();
    ...
    public void lightDown(Location core) {
        List<StructureBlock> structureBlocks = new ArrayList<>(blocks);
        structureBlocks.add(this.core);
        for (StructureBlock structureBlock : structureBlocks) {
            Block block = structureBlock.getVector().getLocation(core).getBlock();
