...
import com.mortisdevelopment.mortisnuclearcraft.nuclearcraft.reactor.Reactor;
import com.mortisdevelopment.mortisnuclearcraft.nuclearcraft.reactor.ReactorManager;
import com.mortisdevelopment.mortisnuclearcraft.nuclearcraft.reactor.ReactorRecipe;
...
public class ReactorConfig extends Config {
    ...
    public void loadConfig() {
        ...
        getConfigManager().getManager().setReactorManager(new ReactorManager(getConfigManager().getManager().getDataManager(), getConfigManager().getManager().getRadiationManager(), reactor, menuItems));
    ...
    private Reactor loadExplosion(ConfigurationSection explosion, List<Structure> structures) {
        ...
        boolean townyPlayerDamage = explosion.getBoolean("towny-player-damage");
        boolean explosionsEnabledPlotsWilderness = explosion.getBoolean("explosions-enabled-plots-wilderness");
        return new Reactor(radius, structures, strength, duration, radiation, vehicles, drain, fire, blockDamage, townyBlockDamage, blockRegen, townyRegen, regenTime, townyPlayerDamage, explosionsEnabledPlotsWilderness);
    }
